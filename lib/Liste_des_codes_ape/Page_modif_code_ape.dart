...
class PageModifCodeAPE extends StatelessWidget {
  int y = 1;
  int nbrConvention = 1;
  static List<String> listeNbrConvention = [];
  String valueNbr = "1";
  List<String> listeConvention = [];
  List<String> listeValueConvention = [];
  ...
  PageModifCodeAPE(this.change, this.codeApe, this.activite, this.description,
      this.domaine, this.valueConvention);
  @override
    ...
    return FutureBuilder(
        ...
        builder: (context, snapshotConvention) {
          if (snapshotConvention.connectionState == ConnectionState.done) {
            ...
            listeNbrConvention = [];
            for (int i = 1; i < valueConvention.length; i++) {
              if (valueConvention[i] == ',' || valueConvention[i] == '}') {
                listeNbrConvention.add("$nbrConvention");
                nbrConvention += 1;
                listeValueConvention.add(valueConvention.substring(y, i));
                y = i + 2;
              }
            }
            valueConvention = listeValueConvention[0];
            return Scaffold(
                                      ...
                                      Column(
                                        children: [
                                          Padding(
                                            ...
                                            child: Text(
                                              "Formulaire de modifiation d'un Code APE",
                                              style: TextStyle(
                                                  fontSize: 30,
